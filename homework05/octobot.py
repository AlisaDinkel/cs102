...
bot = telebot.TeleBot("6005297572:AAH0ewJatxXcv4bBstG8E1D2GxI-bpM41QY")
...
def connect_table(message):
    ...
    url = message.text
    sheet_id = "17IwAcMu2t_-3P4leBGTbOSfcmLsrmQcBDMpMGTImplw"
    try:
...
def choose_action(message):
    ...
    if message.text == "Подключить Google-таблицу":
        ...
        info = bot.send_message(message.chat.id, "Пришлите ссылку на таблицу", reply_markup=start_markup)
